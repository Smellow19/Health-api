	...
	public boolean validateNotNullElements(Patient patient) {
		if ((patient.getFirstname().equals("") || patient.getFirstname() == null)) {
			...
			return false;
				...
				|| IsNumber(patient.getStringAge()) != true) {
